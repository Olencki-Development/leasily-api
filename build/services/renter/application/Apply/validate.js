    ...
    const values = validation_1.default(validation_1.validator.object({
        ...
        history: validation_1.validator
            ...
            pets: validation_1.validator
                ...
                .required(),
            emergencyContacts: validation_1.validator
                .array()
                .items(validation_1.validator.string().trim().required())
                .min(2)
                .required(),
            isSmoker: validation_1.validator.boolean().required(),
            residences: validation_1.validator
                .object({
                current: validation_1.validator
                    .object({
                    ...
                    reference: validation_1.validator
                        .object({
                        name: validation_1.validator.string().trim().required(),
                    ...
                    .required(),
                previous: validation_1.validator
                    .object({
                    address: validation_1.validator.address.required(),
                    start: validation_1.validator.date().iso().max('now').required(),
            ...
            credit: validation_1.validator
                ...
                .required(),
            employment: validation_1.validator
                .object({
                status: validation_1.validator
                    .string()
                    .trim()
                ...
                salary: validation_1.validator
                    ...
                    .required(),
                additionalIncome: validation_1.validator
                    .object({
                    amount: validation_1.validator.number().min(1).valid(null).required(),
                    interval: validation_1.validator
                        .string()
